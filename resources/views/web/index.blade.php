...
@section('content')
    <div class="header">
        ...
        <div class="header-info">
            ...
            <p class="review reviewgo">Genre &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp; Animation, Action, Comedy
            </p>
            <p class="review">Release &nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp; 7 November 2014</p>
            <p class="special">The special bond that develops between plus-sized inflatable robot Baymax, and prodigy Hiro
                Hamada, who team up with a group of friends to form a band of high-tech heroes.</p>
    ...
    <div class="video">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/3MX55DxzUM8?si=JZieXiDvlxNMmZi9"
    ...
    <div class="more-reviews">
        <ul id="flexiselDemo2">
            <li><img src="{{ asset('web/images/m1.jpg') }}" alt="" /></li>
            <li><img src="{{ asset('web/images/m2.jpg') }}" alt="" /></li>
            <li><img src="{{ asset('web/images/m3.jpg') }}" alt="" /></li>
            <li><img src="{{ asset('web/images/m4.jpg') }}" alt="" /></li>
        </ul>
    </div>
@endsection
