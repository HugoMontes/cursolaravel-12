...
@section('content')
    ...
    <div class="card card-primary card-outline mb-4">
        ...
        <form action="{{ route('genero.update', $genero->id) }}" method="POST">
            ...
            <div class="card-body">
                <div class="mb-3">
                    <label for="genero" class="form-label @error('genero') is-invalid @enderror">Genero</label>
                    <input type="text" class="form-control" id="genero" name="genero"
                        value="{{ old('genero', $genero->genero) }}" placeholder="Ingrese nombre del genero" required />
                    @error('genero')
